class AppGroup < ApplicationRecord
  ...
  has_one :kibana_helm_infrastructure, class_name: 'HelmInfrastructure', foreign_key: 'app_group_id'
  has_one :producer_helm_infrastructure, class_name: 'HelmInfrastructure', foreign_key: 'app_group_id'
  ...
  def producer_address
    ...
    helm_infrastructure&.producer_address
  end
  ...
  def kibana_address
    ...
    helm_infrastructure&.kibana_address
  end
