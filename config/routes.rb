Rails.application.routes.draw do
  ...
  match '/app_groups/:app_group_id/delete_infrastructure/:id', to: 'infrastructures#delete_infrastructure', via: [:put, :patch], as: 'delete_infrastructure'
